...
<head>
  ...
  <link rel="stylesheet" href="micro/css/style.css">
    ...
    <div class="container fg-white h-100">
      <div class="row align-items-center h-100">
        <div class="col-lg-6 wow fadeInUp">
          ...
          <h1 class="mb-4 fw-normal">j'apprends a lire et écrire</h1>
          <p class="mb-4">Bonjour je suis Yepie et je vais t'aider.</p>

          <a href="#jouer" class="btn btn-dark">Commencez</a>
          <a href="../../../hackatoon/index.html" class="btn btn-dark">Apprendre à ecrire</a>


        </div>
        <div class="col-lg-6 d-none d-lg-block wow zoomIn">
          <div class="img-place mobile-preview shadow floating-animate">
            <img src="../assets/img/yepie.jpg"style="height: 600px; width: 600px;">
          </div>          
        </div>
      </div>
    </div>
...
<div class="page-section no-scroll" id="jouer">
  <div class="container">
    ...
    <script src="micro/js _etudiant/main.js"></script>
    ...
    <div class="row justify-content-center text-center wow fadeInUp">
      <div class="col-lg-8">
        ...
        <ul class="nav justify-content-center py-3">
          <li class="nav-item"><a href="index.html" class="nav-link fg-white px-4">Acceuil</a></li>
          <li class="nav-item"><a href="" class="nav-link fg-white px-4">tableau de bord</a></li>
          <li class="nav-item"><a href="" class="nav-link fg-white px-4">nous contactez</a></li>
          <li class="nav-item"><a href="" class="nav-link fg-white px-4">Jeux</a></li>
