        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
          <ul class="navbar-nav ml-lg-5 mt-3 mt-lg-0">
            <li class="nav-item dropdown active">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accueil</a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item active" href="../../../chatbot_enfants">Eleve</a>
                <a class="dropdown-item" href="index-2.html">Etudiant</a>
                <a class="dropdown-item" href="blog.php">Analphabet</a>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="updates.html">Nouvelle tendance</a>
            </li>
            <li class="nav-item">
          ...
          <div class="ml-auto my-2 my-lg-0">
            <button class="btn btn-dark rounded-pill">Telechargez l'application </button>
          </div>
        </div>
      </div>
    </nav>
        ...
        <div class="container h-100">
          <div class="row align-items-center h-100">
            <div class="col-lg-6 wow fadeInUp">
              <h1 class="mb-4">Ici apprendre est un plaisir</h1>
              <p class="mb-4">Eleve,Etudiant, Aalphabet  <br>
              nous vous assistont avec le coeur.</p>
            </div>
  ...
  <img src="../assets/img/enfant.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Eleve</h5>
    <p class="card-text">pour vos petits de 4 à 12ans</p>
    <a href="../../../chatbot_enfants" class="btn btn-primary">jouer</a>
  </div>
  </div>
  </div>
  ...
  <div class="card-body">
    ...
    <p class="card-text">nous vous accompagons dans vos études pour le meilleur</p>
    <a href="index-2.html" class="btn btn-primary">parle nous</a>
  </div>
</div>
</div>
<div class="card" style="width: 18rem;">
  <img src="../assets/img/livre.jpg" class="card-img-top" >
  <div class="card-body">
    <h5 class="card-title">Analphabet</h5>
    <p class="card-text">vous aller savoir ecrire et parler</p>
    <a href="blog.html" class="btn btn-primary">Commencer</a>
  </div>
</div>
</div>
            ...
            <div class="iconic-list">
              <div class="iconic-item wow fadeInUp">
                ...
                <div class="iconic-content">
                  <h5> Apprendre différement </h5>
                  <p class="fs-small">Nous voulons donner la possibilité aux enfants d'apprendre en s'ammusant, au Etudiant d'exprimer leurs difficultés et d'avoir un suivie en fonction de leurs préoccupation, au analphabet de pouvoir lire et ecrire</p>
                </div>
              </div>
              <div class="iconic-item wow fadeInUp">
                ...
                <div class="iconic-content">
                  ...
                  <h5>Suivre et être Suivie</h5>
                  <p class="fs-small">Nous donnons la possibilité aux parents de suivre l'évolution de leurs enfants mais aussi a l'etablissement de se faire une idée des difficultés de l'étudiant </p>
                </div>
              </div>
              <div class="iconic-item wow fadeInUp">
                ...
                <div class="iconic-content">
                  <h5> Mentoring </h5>
                  <p class="fs-small">nos assistants Koffi, Mariam et Yepie nos assistant vocaux vont vous assister tout le long de votre parcours</p>
                </div>
              </div>
            </div>
          </div>
   ...
   <div class="page-section bg-dark fg-white">
      <div class="container">
        <h1 class="text-center">pourquoi choisir Tell Me</h1>
        ...
        <div class="row justify-content-center mt-5">
          <div class="col-md-6 col-lg-3 py-3">
            <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
              ...
              <p class="fs-large">apprendre rapidement</p>
              <p class="fs-small fg-grey">en jouant vous allez vous découvrir et apprendre</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 py-3">
            <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
              ...
              <p class="fs-large"> Facilite l'echange professeur étudiant </p>
          ...
          <div class="col-md-6 col-lg-3 py-3">
            <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
              ...
              <p class="fs-large">apprendre aux autres</p>
              <p class="fs-small fg-grey">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 py-3">
            <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
              ...
              <p class="fs-large">vous faire économiser</p>
              <p class="fs-small fg-grey">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 py-3">
            <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
              ...
              <p class="fs-large">maitriser les technologies</p>
              <p class="fs-small fg-grey">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed</p>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-5 mb-5 mb-lg-0 wow fadeInUp">
            ...
            <a href="#" class="btn btn-gradient btn-split-icon rounded-pill">
              <span class="icon mai-call-outline"></span> appelez
            </a>
          </div>
          <div class="col-lg-7">
            <div class="pricing-table">
              <div class="pricing-item active wow zoomIn">
                <div class="pricing-header">
                  <h5>Forfait Etablissement</h5>
                  <h1 class="fw-normal">150.000f</h1>
                </div>
                <div class="pricing-body">
                  <ul class="theme-list">
                    <li class="list-item">acces aux etudiants </li>
                    <li class="list-item">aces aux parents</li>
                    <li class="list-item">en temps réel</li>
                    <li class="list-item">1mois de suivie</li>
              ...
              <div class="pricing-item wow zoomIn" data-wow-delay="200ms">
                <div class="pricing-header">
                  <h5>Forfaits parentales</h5>
                  <h1 class="fw-normal">15.000f</h1>
                </div>
                <div class="pricing-body">
                  <ul class="theme-list">
    ...
    <div class="page-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 py-3">
            <h1 class="wow fadeInUp">Besoin de plus d'informations? <br>
            Contactez nous</h1>

            <form method="POST" class="mt-5">
              <div class="form-group wow fadeInUp">
                <label for="name" class="fw-medium fg-grey">Nom et Prénom</label>
    ...
    <div class="page-footer-section bg-dark fg-white">
      <div class="container">
        <div class="row mb-5 py-3">
            ...
            <h5 class="mb-3">Ecrire</h5>
            <p>sugesttion remarque</p>
            <form method="POST">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-6 py-2">
            ...
            <p class="d-inline-block ml-2">Copyright &copy; <a href="https://www.macodeid.com/" class="fg-white fw-medium">GEEK GIRL</a>. All rights reserved</p>
          </div>
          <div class="col-12 col-md-6 py-2">
