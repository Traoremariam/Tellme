...
let intro = ["Salut,je suis mariam,et toi comment t'appel tu?"];
...
function chatbotvoice(message){
    ...
    if (message.split(" ").includes("m'appelle")) {
        ...
        let finalresult =  "tu as un jolie prénom " + prenom[taill-1] + ". ";
        speech.text = finalresult;
    }
